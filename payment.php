                    ...
                    <div id="accordion" class="checkout">
                        <div class="panel checkout-step">
                            <div> <span class="checkout-step-number"><i class="fa-solid fa-user" style="color: #ffbb00;"></i></span>
                                <h4 class="checkout-step-title"> <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" style="nav-link">Logged In</a></h4>
                            </div>
                            <div id="collapseOne" class="collapse in">
                                <div class="checkout-step-body">
                                    <p>Bhuvanesan S | 9080777754</p>
                                    <div class="row">
                                        <div class="col-lg-8">
                        ...
                        <div class="panel checkout-step">
                            <div role="tab" id="headingTwo"> <span class="checkout-step-number"><i class="fa-solid fa-location-pin" style="color: #ffbb00;"></i></span>
                                <h4 class="checkout-step-title"> <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" > Delivery Address </a></h4>  <p class="d-flex justify-content-end text-warning">CHANGE</p>
                            </div>
                            <div id="collapseTwo" class="panel-collapse collapse">
                                <div class="checkout-step-body">
                                    <div class="checout-address-step">
                                        <div class="row">
                                            <form class="">
                                                <p>Maruthi complex, 65/2b, Hoodi Main Rd, Ayyappa Nagar, Krishnarajapura, Bengaluru, Karnataka 560036</p>
                                                <p>66 Mins</p>
...
<!-- 
                        ...
                        <div class="panel checkout-step">
                            <div role="tab" id="headingFour"> <span class="checkout-step-number"><i class="fa-solid fa-credit-card" style="color: #ffae00;"></i></span>
                                <h4 class="checkout-step-title"> <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseFour"  > Choose a Payment Method </a> </h4>
                            </div>
                            <div id="collapseFour" class="panel-collapse collapse">
                                <div class="checkout-step-body">
                    
                                    <a href="proceedpay.php" class="btn btn-default btn-lg btn-warning">Procceed to pay</a>
                                </div>
                            </div>
                        </div>
                    </div>
