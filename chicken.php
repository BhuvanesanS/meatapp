                     ...
                     <div class="product-new-filter-block">
                         <div class="col-lg-4 custom-tabs-prdt">
                            <div class="product-thumbnail">
                              <a href="javascript:;">
                                 <img src="images/Chicken/chiku1.jpg" class="img-fluid" alt="img">
                              </a>
                           </div>
                            <div class="product-body p-4">
                              <h5 class="product-title">
                                 <a href="product-single.html" title="Beef">Chicken Curry Cut - Small Pieces </a>
                                 <p class="product-text">Juicy bone-in & boneless chicken for delectable curries</p>
                              </h5>
                             <!--  <ul class="star-review">
                              ...
                              <p class="product-text product-text-bg p-1 text-center">Weight: 500gms | 6-7 pieces | Serves 2 </p>
                                 ...
                                 <a href="#" class="px-0 pt-2"><span class="product-price">199₹ <span>149₹</span></span></a>
                                 <a href="chickencustomize.php" class="custom-btn btn btn-sm btn-shop mb-5">Customize</a>
                              </div>                            
                           </div>
                        </div>
                        <div class="col-lg-4 custom-tabs-prdt">
                            <div class="product-thumbnail">
                              <a href="javascript:;">
                                 <img src="images/Chicken/chiku2.jpg" class="img-fluid" alt="img">
                              </a>
                           </div>
                            <div class="product-body p-4">
                              <h5 class="product-title">
                                 <a href="product-single.html" title="Beef">Chicken Breast - Boneless </a>
                                 <p class="product-text">Enjoy tender pieces of juicy chicken breast</p>
                              </h5>
                             <!--  <ul class="star-review">
                                 <li> <a href="javascript:;"><i class="fa fa-star" aria-hidden="true"></i></a> </li>
                                 <li> <a href="javascript:;"><i class="fa fa-star" aria-hidden="true"></i></a> </li>
                              ...
                              <p class="product-text product-text-bg p-1 text-center">Weight: 500gms | 6-7 pieces | Serves 2 </p>
                                 <div class="d-grid mt-4 gap-2 d-sm-flex justify-content-start justify-content-sm-center mb-5">
                                 <a href="#" class="px-0 pt-2"><span class="product-price">199₹ <span>149₹</span></span></a>
                                 <a href="chickenaddcart.php" class="custom-btn btn btn-sm btn-shop mb-5">Add Cart</a>
                              </div>                            
                           </div>
                        </div>
                        <div class="col-lg-4 custom-tabs-prdt">
                            <div class="product-thumbnail">
                              <a href="javascript:;">
                                 <img src="images/Chicken/chiku3.jpeg" class="img-fluid"  alt="img">
                              </a>
                           </div>
                            <div class="product-body p-4">
                              <h5 class="product-title">
                                 <a href="product-single.html" title="Beef">Chicken Curry Cut - Small Pieces (Large Pack) </a>
                                 <p class="product-text">The ideal pack for a big, delicious curry feast</p>
                              </h5>
                             <!--  <ul class="star-review">
                                 <li> <a href="javascript:;"><i class="fa fa-star" aria-hidden="true"></i></a> </li>
                                 <li> <a href="javascript:;"><i class="fa fa-star" aria-hidden="true"></i></a> </li>
                              ...
                              <p class="product-text product-text-bg p-1 text-center">Weight: 500gms | 6-7 pieces | Serves 2 </p>
                                 ...
                                 <a href="#" class="px-0 pt-2"><span class="product-price">299₹ <span>229₹</span></span></a>
