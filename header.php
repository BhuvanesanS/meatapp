...
<head>
 ...
 <!-- Bootstrap5.3.2 Link start -->
  <!-- Icon Font Stylesheet -->
        <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.15.4/css/all.css"/>
        <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.4.1/font/bootstrap-icons.css" rel="stylesheet">
   <!-- Bootstrap5.3.2 Link end -->
                        ...
                        <ul class="social-list mb-4 d-inline  d-flex justify-content-center">
                           ...
                           <li  class="nav-link "><i class="fa fa-sign-in-alt" aria-hidden="true"></i>
                              <a data-bs-toggle="offcanvas" href="#offcanvasExample" role="button" aria-controls="offcanvasExample" class="fs-6">
                                 Login</a>
                                   <a href="signup.php" class="fs-6">/</i>
                                 SignUp</a>
                           </li>

                           <li class="nav-link "><span><i class="fa fa-shopping-cart" aria-hidden="true"></i></span>
                             <!-- calling cart function -->
                          </li>     <a  class="fs-6" data-bs-target="#offcanvasRight" data-bs-toggle="offcanvas" href="javascript:;"><sup><?php cart_item();  //total_cart_price();?></sup> cart&nbsp;</a>
...
<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
  ...
  <div class="offcanvas-body">
    ...
    <form action="" method="" class="loginform" >
      ...
      <input type="text" name="phnmuner" id="phnnumber" style=" width: 100%;
  margin: 2px 0;
  box-sizing: border-box;
  border: none;
  border-bottom: 1px solid black;">
      <button class="btn btn w-100 mt-3 text-dark" type="button" style="background-color:#ffde59">Send OTP</button>
      </form>
      </div>
      <div class="mt-5">
  ...
  <div class="card pb-5">
   ...
   <div class="d-grid  gap-2 d-sm-flex justify-content-sm-start">
           ...
           <li >₹ 299</li>
            ...
            <li style="text-decoration: line-through;">₹ 399</li>
           </ul>
...
<!-- cart page popup end -->
                      ...
                      <!--  <div class="col-md-3 col-sm-3 col-xs-6  ">
                        <ul class="social-list  d-inline mt-5 d-flex justify-content-center align-items-center"> 
                           <li class="cart-link  menu-click1 ps-rel">
                                 <a class="nav-link" href="javascript:;">Cart &nbsp;<i class="fa fa-shopping-cart" aria-hidden="true"></i></a> -->
                  ...
                  <div class="row">
                  	<div class="col-lg-12 col-md-1">
                        <!-- <div class="index1-logo">
                           <a href="index.html">
                              <img src="images/logo.png" alt="logo" class="img-fluid justify-content-end" width="212" height="40">
                           </a>
                        </div> -->
                        <nav class="navbar navbar-expand-lg">
                           ...
                           <li class="nav-item menu-click4 ps-rel">
                              ...
                              <!-- <li class="nav-item">
                                 <a class="nav-link" href="store.html">Vegetarian</a>
                              </li> -->
                          ...
                          <form action="search_product.php" method="get" class=" d-flex justify-content-end align-self-end">
						        <input type="text" class="form-control frm-search px-5" type="search"  placeholder="Search" name="search_data"aria-label="Search">
